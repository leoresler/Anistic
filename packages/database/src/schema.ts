...
export const animes = pgTable(
  "animes",
  {
    ...
    relevanceScore: numeric("relevance_score", { precision: 8, scale: 2 }),
    year: integer("year"),
    season: text("season"),
    studio: text("studio"),
    rating: text("rating"),
  ...
  (table) => [
    ...
    index("animes_format_country_relevance_idx").on(table.format, table.countryOfOrigin, table.relevanceScore.desc()),
